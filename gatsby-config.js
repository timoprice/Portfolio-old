module.exports = {
  siteMetadata: {
    ...
    about: 
      `I'm \n a User Experience researcher & strategist from Austin, TX, with a background in ethnographic research, education, business administration, and digital experience design. 
